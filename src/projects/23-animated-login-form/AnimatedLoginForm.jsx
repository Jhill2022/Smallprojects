 ...
 e.preventDefault()
  ...
  return (
    <LoginContainer className={rotate.animation}>
        ...
        className={rotate.animation}></FormAnimation>
      <form className="card m-1 m-auto" style={formStyle} onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <Button btnClass={'btn-block'} text="Submit" onSubmit={handleSubmit}/>
          <small className='text-accept'>Don't have a account?</small>
          <label className='mt-1 fw-200 text-right' style={{ textDecoration:"underline", cursor: "pointer"}}>Register</label>
        </div>
      </form>
    </LoginContainer>
  );
