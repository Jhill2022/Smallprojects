...
export default function () {
  ...
  return (
    <div className="m-auto">
        {submit && valid ? (<><Alert type={"success"} message={"Registration was successful!"} delay={true} delayTime ={5000}/> <Title text={`Welcome ${values.user_name}`}/> </>):
      <div className="container m-auto mt-4 p-2 shadow-sm border-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            />
            {submit && !values.password ? <label className="text-danger fs-sm">
